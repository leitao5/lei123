<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"D:\phpstudy\PHPTutorial\WWW\tpmall\public/../application/admin\view\auth_group\add.html";i:1558596150;s:76:"D:\phpstudy\PHPTutorial\WWW\tpmall\application\admin\view\layout\layout.html";i:1558417939;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
  ...
  <body>
    <div class="x-body">
        <form  method="post" action="<?php echo url('AuthGroup/add'); ?>" class="layui-form layui-form-pane" >
                <div class="layui-form-item">
                    <label for="titile" class="layui-form-label">
                        <span class="x-red">*</span>角色名
                    </label>
                    <div class="layui-input-inline">
                        <input type="text" id="titile" name="titile" required="" lay-verify="required"
               ...
               <div class="layui-form-item layui-form-text">
                    ...
                    <table  class="layui-table layui-input-block">
                        <tbody>
                       <?php foreach($auth_rule as $k=>$v): ?>
                            <tr>
                                <td>
                                   <?php echo $v['auth_cate']; ?>
                                    <input name="id[]" type="checkbox" value="2">
                                </td>
                                <td>
                                    <div class="layui-input-block">
                                        <input name="id[]" type="checkbox" value="2"> <?php echo $v['title']; ?>
