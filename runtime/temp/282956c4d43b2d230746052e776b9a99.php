<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"D:\phpstudy\PHPTutorial\WWW\tpmall\public/../application/admin\view\auth_group\lst.html";i:1558591497;s:76:"D:\phpstudy\PHPTutorial\WWW\tpmall\application\admin\view\layout\layout.html";i:1558417939;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加角色','<?php echo url('AuthGroup/add'); ?>')"><i class="layui-icon"></i>添加</button>
      ...
      <table class="layui-table">
        ...
        <tbody>
        <?php foreach($authgroup as $k=>$v): ?>
          <tr>
            <td>
              <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='2'><i class="layui-icon">&#xe605;</i></div>
            </td>
            <td><?php echo $v['id']; ?></td>
            <td><?php echo $v['titile']; ?></td>
            <td><?php if($v['status'] ==  1): ?>   <span class="layui-btn layui-btn-normal layui-btn-mini">已启用</span></td> <?php else: ?>禁用 <?php endif; ?></td>
