<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\phpstudy\PHPTutorial\WWW\tpmall\public/../application/admin\view\category\lst.html";i:1558345411;s:76:"D:\phpstudy\PHPTutorial\WWW\tpmall\application\admin\view\layout\layout.html";i:1558417939;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加商品分类','<?php echo url('Category/add'); ?>')"><i class="layui-icon"></i>添加</button>
      ...
      <table class="layui-table">
        ...
        <?php if(is_array($CategoryRes) || $CategoryRes instanceof \think\Collection || $CategoryRes instanceof \think\Paginator): $i = 0; $__LIST__ = $CategoryRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
          ...
          <tr>
            ...
            <td> <?php if($cate['show_cate'] == 1): ?> <img src="http://127.0.0.1/tpmall/public/static/admin/images/right.png" height="30"> <?php else: ?><img src="http://127.0.0.1/tpmall/public/static/admin/images/wrong.png" height="30">    <?php endif; ?></td>
            <td><input type="text" value="<?php echo $cate['sort']; ?>" style="width: 8%;text-align: center;"></td>
              <td class="td-manage">
                <a title="查看"  onclick="x_admin_show('编辑','<?php echo url('Category/edit',['id'=>$cate['id']]); ?>')" href="javascript:;">
