<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpstudy\PHPTutorial\WWW\tpmall\public/../application/admin\view\goods\lst.html";i:1558505513;s:76:"D:\phpstudy\PHPTutorial\WWW\tpmall\application\admin\view\layout\layout.html";i:1558417939;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <a href="<?php echo url('Goods/add'); ?>"><button class="layui-btn" ><i class="layui-icon"></i>添加</button></a>
