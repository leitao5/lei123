<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpstudy\PHPTutorial\WWW\tpmall\public/../application/admin\view\admin\add.html";i:1558591676;s:76:"D:\phpstudy\PHPTutorial\WWW\tpmall\application\admin\view\layout\layout.html";i:1558417939;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="x-body">
        <form class="layui-form"  method="post" action="<?php echo url('Admin/add'); ?>">
          <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                <label for="username" class="layui-form-label">
                    <span class="x-red">*</span>所属的用户组
                </label>
                <div class="layui-input-inline">
                    <select id="shipping" name="groupid" class="valid">
                        <?php foreach($auth_group as $k=>$v): ?>
                        <option value="<?php echo $v['id']; ?>"><?php echo $v['titile']; ?></option>
                        <?php endforeach; ?>
                    </select>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="password" id="L_repass" name="possword" required="" lay-verify="repass"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
