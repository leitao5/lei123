<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpstudy\PHPTutorial\WWW\tpmall\public/../application/admin\view\admin\lst.html";i:1558520258;s:76:"D:\phpstudy\PHPTutorial\WWW\tpmall\application\admin\view\layout\layout.html";i:1558417939;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加管理员','<?php echo url('Admin/add'); ?>','800','500')"><i class="layui-icon"></i>添加</button>
      ...
      <table class="layui-table">
        ...
        <?php foreach($adminRes as $k=>$v): ?>
          <tr>
            ...
            <td><?php if($v['status'] == 1): ?> <span class="layui-btn layui-btn-normal layui-btn-mini">已启用</span>
              <?php else: ?>
              <span class="layui-btn layui-btn-normal layui-btn-mini">冻结</span>
              <?php endif; ?></td>

            <td class="td-manage">
              <a onclick="member_stop(this,'10001')" href="javascript:;"  title="启用">
              </a>
              <a title="编辑"  onclick="x_admin_show('编辑','<?php echo url('admin/edit',['id'=>$v['id']]); ?>')" href="javascript:;">
